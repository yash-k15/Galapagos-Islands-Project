...
import fullGalapago from "./screens/Home/IslandMaps/fullGalapago";
import SantaCruzI from "./screens/Home/IslandMaps/SantaCruzI";
import Isabella from "./screens/Home/IslandMaps/Isabella";
import SanCristobal from "./screens/Home/IslandMaps/SanCristobal";
import Floreana from "./screens/Home/IslandMaps/Floreana";
...
const HomeSection = createStackNavigator({
    ...
    fullGalapago: {screen: fullGalapago},
    SantaCruzI: {screen: SantaCruzI},
    Isabella: {screen: Isabella},
